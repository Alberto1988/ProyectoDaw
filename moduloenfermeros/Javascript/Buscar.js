...
function presionTecla(e){
  ...
  conexion1.open('GET','./moduloenfermeros/modelo/buscarEnfermerosAjax.php?cedula='+document.getElementById('cedula').value+"&radio1="+document.getElementById('radio1').checked+
