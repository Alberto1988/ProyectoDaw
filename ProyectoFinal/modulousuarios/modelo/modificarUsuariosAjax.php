...
else if($_GET["usuario"]=="")//el us no introduce nada en el input text
	...
	if ($resultado->num_rows > 0){
			...
			while ($obj = $resultado->fetch_object()){
				...
				$cadena.='<tr>';
					...
					$cadena.= '<td align="right"><a href="index.php?controlador=usuarios&accion=modificar2&val=ok&mod='.$obj->id_usuario.'">Modifica</a></td>'; 
				$cadena.='</tr>';
			} 
			$cadena.='</TABLE>';	
	}
