...
function inicializarEventos(){
  var ob=document.getElementById('clave1');
...
function presionTecla(e){
  ...
  conexion1.open('GET','./modulopacientes/modelo/buscarPacientesAjax.php?clave1='+document.getElementById('clave1').value+"&radio1="+document.getElementById('radio1').checked+
