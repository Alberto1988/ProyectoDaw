...
function presionTecla(e){
  ...
  conexion1.open('GET','./modulomedicos/modelo/modificarMedicosAjax.php?cedula='+document.getElementById('cedula').value+"&radio1="+document.getElementById('radio1').checked+
