...
function presionTecla(e){
  ...
  conexion1.open('GET','./modulopacientes/modelo/modificarPacientesAjax.php?nombre='+document.getElementById('nombre').value+"&radio1="+document.getElementById('radio1').checked+
