...
function presionTecla(e){
  ...
  conexion1.open('GET','./modulousuarios/modelo/modificarUsuariosAjax.php?usuario='+document.getElementById('usuario').value+"&radio1="+document.getElementById('radio1').checked+
