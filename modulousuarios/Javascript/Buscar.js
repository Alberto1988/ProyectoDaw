...
function inicializarEventos(){
  var ob=document.getElementById('usuario1');
...
function presionTecla(e){
  ...
  conexion1.open('GET','./modulousuarios/modelo/buscarUsuariosAjax.php?usuario1='+document.getElementById('usuario1').value+"&radio1="+document.getElementById('radio1').checked+
